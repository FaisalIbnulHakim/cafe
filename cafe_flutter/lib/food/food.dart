...
import 'package:cafe_flutter/food/setting_food.dart';
...
class _FoodState extends State<Food> {
  ...
  @override
  void didUpdateWidget(covariant Food oldWidget) {
        ...
        actions: [
          IconButton(
            ...
            onPressed: () async {
              ...
              await Navigator.pushNamed(context, SettingFood.routeName);
